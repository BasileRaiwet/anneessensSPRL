				...
				<div class="col-md-12 text-center">
					<p>
						<small class="block">
							...
							</script>Anneessens SPRL Tout droit réservés | this website is made with <i
								class="icon-heart3" aria-hidden="true"></i> by <a href="http://basileraiwet.com"
								target="_blank">Basile Raiwet</a>
							<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						</small>
					</p>
				</div>
