			...
			<div class="container">
				<div class="row row-pb-lg">
					...
					<div class="col-md-4 animate-box">
						...
						<p class="downloadreport text-center"><a href="#"><i class="icon-download3"></i> Ca m'interesse !</a></p>
					</div>
				</div>
				<div class="row row-pb-lg">
				...
				<div class="row">
					...
					<div class="col-md-4 animate-box">
						<div class="project-entry">
							<a href="raccordements-egouts.php" class="project-img text-center" style="background-image: url(../images/building-5.jpg);">
								<span class="icon"><i class="icon-search2"></i></span>
							</a>
							<div class="desc">
					...
					<div class="col-md-4 animate-box">
						<div class="project-entry">
							<a href="epuration-eaux.php" class="project-img text-center" style="background-image: url(../images/building-6.jpg);">
								<span class="icon"><i class="icon-search2"></i></span>
							</a>
							<div class="desc">
